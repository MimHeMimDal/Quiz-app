...
export const Question = function () {
  ...
  return (
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white flex flex-col  gap-8 px-7 py-10 w-2/3 rounded">
      <div className="text-end text-green-500">
        Correct Answers: {correctAnswer}/{state.length}
      </div>
      <div className="text-center flex flex-col items-center justify-center gap-5">
        <h2 className=" text-3xl font-bold">{state[pageCounter].question}</h2>
